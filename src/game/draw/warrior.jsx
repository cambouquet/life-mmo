...
export function drawWarriorSprite(ctx, x, y, facing, frame) {
  ...
  if (facing === 'down') {
    r(3,  6+bob,10, 9,PC.cape);   r(4,  5+bob, 8, 2,PC.capeDk)
    r(4,  6+bob, 8, 7,PC.armor);  r(5,  6+bob, 6, 2,PC.armorLt); r(5, 8+bob,1,4,PC.armorLt)
    r(4, 12+bob, 8, 2,PC.belt)
    r(2,  6+bob, 3, 4,PC.armorLt); r(11, 6+bob,3,4,PC.armorLt)
    r(13, 5+bob, 1, 8,PC.sword);  r(12, 5+bob,1,1,PC.sword)
    r(12, 9+bob, 3, 1,PC.swordHlt); r(13,10+bob,1,3,PC.swordGrp)
    r(1,  6+bob, 3, 5,PC.shield); r(1,6+bob,3,1,PC.shieldRim); r(1,10+bob,3,1,PC.shieldRim)
    p(2,  8+bob,PC.shieldRim)
    r(4, 13+bob, 3, 3,PC.armorDk); r(9,13+bob,3,3,PC.armorDk)
    r(4, 15+bob, 3, 1,PC.boot);   r(9,15+bob,3,1,PC.boot)
    r(4,0,8,7,PC.helm); r(4,0,8,2,PC.helmLt)
    p(5,1,PC.armorLt); p(10,1,PC.armorLt)
    r(5,4,6,1,PC.visor); r(5,5,6,2,PC.skin)
    p(6,5,PC.eye); p(9,5,PC.eye)
  }

  if (facing === 'up') {
    r(3, 6+bob,10,9,PC.cape)
    r(4, 6+bob, 8,7,PC.armor); r(4,12+bob,8,2,PC.belt)
    r(2, 6+bob, 3,4,PC.armorLt); r(11,6+bob,3,4,PC.armorLt)
  ...
  if (facing === 'left') {
    ...
    r(4, 6+bob, 7,7,PC.armor); r(4,6+bob,5,2,PC.armorLt); r(4,12+bob,7,2,PC.belt)
    r(1, 6+bob, 4,5,PC.shield); r(1,6+bob,1,5,PC.shieldRim)
    ...
    r(4,0,7,7,PC.helm); r(4,0,7,2,PC.helmLt)
    r(4,4,5,1,PC.visor); r(4,5,5,2,PC.skin)
    p(5,5,PC.eye)
  }

  if (facing === 'right') {
    r(4, 6+bob, 9,9,PC.cape)
    r(5, 6+bob, 7,7,PC.armor); r(7,6+bob,5,2,PC.armorLt); r(5,12+bob,7,2,PC.belt)
    r(11,6+bob, 4,5,PC.shield); r(14,6+bob,1,5,PC.shieldRim)
    ...
    r(5,0,7,7,PC.helm); r(5,0,7,2,PC.helmLt)
    r(7,4,5,1,PC.visor); r(7,5,4,2,PC.skin)
    p(10,5,PC.eye)
  }
}
