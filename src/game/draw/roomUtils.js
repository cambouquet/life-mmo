...
export function floorColor(row) {
  return spriteColors.floor[row] ?? spriteColors.floor[0]
}

export function wallColor(row) {
  return spriteColors.wall[row] ?? spriteColors.wall[0]
}
